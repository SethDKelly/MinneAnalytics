...
resource "aws_ecs_task_definition" "app" {
  ...
  container_definitions = jsonencode([{
    ...
    environment = [
      ...
      { name = "MIGRATION_ENVIRONMENT", value = "aws-dev" },
      ...
      { name = "MINNE_V0_WRITE_LIFECYCLE_DISCLOSURE", value = "true" },
      { name = "MINNE_V0_WRITE_PUBLICATION", value = "true" },
      { name = "MINNE_V0_WRITE_SCHEDULE", value = "true" },
      { name = "MINNE_V0_WRITE_DISPATCH", value = "true" },
      { name = "MINNE_V0_SEMANTIC_READS", value = "true" },
